import { LayoutDashboard, LogOut, Menu, X, Film, QrCode } from "lucide-react";

export default function SidebarCaissier({
                                            sidebarOpen,
                                            setSidebarOpen,
                                            activeMenu,
                                            setActiveMenu,
                    ...
                    {sidebarOpen && (
                        <div className="flex items-center gap-3 flex-1">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-zinc-600 tracking-wide">Espace Caissier</p>
                            </div>
                        </div>
                    )}
                    <button
