...
import { Tag, Calendar, Search, Check, Plus, Trash, User, Activity } from 'lucide-react';
...
export default function HistoriqueOffres() {
    ...
    const fetchHistory = async () => {
        ...
        try {
            ...
            const response = await adminApi.getFilteredOfferHistory(params);
    ...
    const fetchStats = async () => {
        try {
            const response = await adminApi.getGlobalOfferHistoryStats();
    ...
    return (
        <HistoriqueTable
            ...
            isLoading={isLoading}
            stats={stats}
            pageName="HistoriqueOffres"
            exportEndpoint="/admin/historique/offres/export/excel"
            exportParams={{
            ...
            filters={
                <>
                    ...
                    <div className="flex items-center gap-2 bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2">
                        ...
                        <input
                            type="text"
                            placeholder="Rechercher (Admin ou Offre)..."
