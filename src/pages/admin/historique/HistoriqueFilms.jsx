...
import { Film, Calendar, Search, Check, Plus, Trash, User, Activity } from 'lucide-react';
...
export default function HistoriqueFilms() {
    ...
    const fetchHistory = async () => {
        ...
        try {
            ...
            const response = await adminApi.getFilteredFilmHistory(params);
    ...
    const fetchStats = async () => {
        try {
            const response = await adminApi.getGlobalFilmHistoryStats();
    ...
    return (
        <HistoriqueTable
            title="Historique Films"
            icon={Film}
            data={data}
            columns={columns}
            isLoading={isLoading}
            stats={stats}
            pageName="HistoriqueFilms"
            exportEndpoint="/admin/historique/films/export/excel"
            exportParams={{
            ...
            filters={
                <>
                    ...
                    <div className="flex items-center gap-2 bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2">
                        ...
                        <input
                            type="text"
                            placeholder="Rechercher (Admin ou Film)..."
