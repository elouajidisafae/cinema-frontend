...
export default function AfficherCommerciauxActifs() {
    ...
    const fetchUsers = async () => {
        setLoading(true);
        try {
            const response = await adminApi.getUsers("COMMERCIAL", true);
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-white">Commerciaux Actifs</h2>
                        <p className="text-zinc-500 text-sm">Liste des commerciaux actuellement actifs</p>
                    </div>
                </div>

                <div className="flex gap-2">
                    <button
                        onClick={() => navigate('/admin/commerciaux/archives')}
                    ...
                    <button
                        onClick={() => navigate('/admin/commerciaux/ajouter')}
            ...
            <div className="mb-6">
                <div className="relative max-w-md">
                    ...
                    <input
                        ...
                        className="w-full bg-zinc-900/30 border border-zinc-800 rounded-xl py-2.5 pl-10 pr-4 text-white placeholder-zinc-600 focus:outline-none focus:border-blue-500/50 transition-all text-sm"
                    />
                </div>
            </div>
